...
Найчастіше всього при обробці результатів опитування використовуються методи математичної статистики.
В залежності від мети опитування при обробці оцінок можуть вирішуватися наступні проблеми:
* **Формування загальної оцінки.** Для формування загальної оцінки групи експертів найчастіше використовуються середні велечини. Наприклад, медіана;
* **Визначення відносних ваг об'єктів.** Іноді кажуть, що потрібно визначити, на скільки той чи інший фактор важливий з точки зору будь-якого критерію. В такому випадку визначають вагу кожного фактора;
* **Встановлення ступеня погодження думок експертів.** У випадку участі в опитуванні кількох експертів, розбіжність у оцінках яких досить ймовірна, однак величина цієї розбіжності має важливе значення. Групова оцінка може рахуватися достатньо надійною тільки за умови хорошої збіжності відповідей окремих спеціалістів.
